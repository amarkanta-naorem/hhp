        ...
        {submitSuccess ? (
          <div className="text-center p-12">
            ...
            <p className="text-gray-700 max-w-md mx-auto mb-8">
              Our team will contact you shortly to coordinate the blood donation.
            </p>
          </div>
        ) : (
            ...
            <div className="space-y-4">
              <div className="bg-gray-50/50 p-6 rounded-xl border border-gray-300 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <label
                      htmlFor="patient_blood_group"
                      className="block text-sm font-medium text-gray-700"
                    >
                      Patient Blood Group <span className="text-red-500">*</span>
                    </label>
                    <select
                ...
                <AttendantForm
                  attendants={formData.attendants}
                  handleAttendantChange={handleAttendantChange}
              ...
              <div className="bg-gray-50/50 p-6 rounded-xl border border-gray-300 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label
                      htmlFor="blood_request_type"
                      className="block text-sm font-medium text-gray-700"
                    >
                      Requested Blood Type <span className="text-red-500">*</span>
                    </label>
                    <select
                      id="blood_request_type"
                      name="blood_request_type"
                      value={formData.blood_request_type}
                      onChange={handleInputChange}
                      required
                      className="w-full px-4 py-3 bg-white text-gray-900 border border-gray-300 rounded-lg focus:ring-0 focus:ring-red-500 focus:border-red-500 outline-none transition-all"
                    >
                      ...
                      <option value="PRBC" className="text-gray-900">
                        PRBC
                      </option>
                      <option value="SDP" className="text-gray-900">
                        SDP
                      </option>
                      <option value="PC/RDP/PRP" className="text-gray-900">
                        PC/RDP/PRP
                      </option>
                      <option value="FFP" className="text-gray-900">
                        FFP
                      </option>
                      <option value="LD" className="text-gray-900">
                        LD
                      </option>
                    </select>
                  </div>
                  ...
                  <div className="space-y-2">
                    <label
                      ...
                      className="block text-sm font-medium text-gray-700"
                    >
                      Haemoglobin <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="text"
                      id="haemoglobin"
                ...
                <div className="mt-4">
                  <label className="block text-lg font-semibold text-gray-800 mb-2">
                    Transfusion Till Date
                  </label>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="space-y-2">
                      <label
                        htmlFor="transfusion_till_date.PRBC"
                        className="block text-sm font-medium text-gray-700"
                      >
                        PRBC
                      </label>
                      <input
                        type="number"
                        id="transfusion_till_date.PRBC"
                        name="transfusion_till_date.PRBC"
                        value={formData.transfusion_till_date.PRBC}
                        onChange={handleInputChange}
                        className="w-full px-4 py-3 bg-white text-gray-900 border border-gray-300 rounded-lg focus:ring-0 focus:ring-red-500 focus:border-red-500 outline-none transition-all"
                        placeholder="Units"
                      />
                    ...
                    <div className="space-y-2">
                      <label
                        htmlFor="transfusion_till_date.SDP"
                        className="block text-sm font-medium text-gray-700"
                      >
                        SDP
                      </label>
                      <input
                        type="number"
                        id="transfusion_till_date.SDP"
                        name="transfusion_till_date.SDP"
                        value={formData.transfusion_till_date.SDP}
                        onChange={handleInputChange}
                        className="w-full px-4 py-3 bg-white text-gray-900 border border-gray-300 rounded-lg focus:ring-0 focus:ring-red-500 focus:border-red-500 outline-none transition-all"
                        placeholder="Units"
                      />
                    ...
                    <div className="space-y-2">
                      <label
                        htmlFor="transfusion_till_date.PC/RDP/PRP"
                        className="block text-sm font-medium text-gray-700"
                      >
                        PC/RDP/PRP
                      </label>
                      <input
                        type="number"
                        id="transfusion_till_date.PC/RDP/PRP"
                        name="transfusion_till_date.PC/RDP/PRP"
                        value={formData.transfusion_till_date["PC/RDP/PRP"]}
                        onChange={handleInputChange}
                        className="w-full px-4 py-3 bg-white text-gray-900 border border-gray-300 rounded-lg focus:ring-0 focus:ring-red-500 focus:border-red-500 outline-none transition-all"
                        placeholder="Units"
                      />
                    ...
                    <div className="space-y-2">
                      <label
                        htmlFor="transfusion_till_date.FFP"
                        className="block text-sm font-medium text-gray-700"
                      >
                        FFP
                      </label>
                      <input
                        type="number"
                        id="transfusion_till_date.FFP"
                        name="transfusion_till_date.FFP"
                        value={formData.transfusion_till_date.FFP}
                        onChange={handleInputChange}
                        className="w-full px-4 py-3 bg-white text-gray-900 border border-gray-300 rounded-lg focus:ring-0 focus:ring-red-500 focus:border-red-500 outline-none transition-all"
                        placeholder="Units"
                      />
                    ...
                    <div className="space-y-2">
                      <label
                        htmlFor="transfusion_till_date.LD"
                        className="block text-sm font-medium text-gray-700"
                      >
                        LD
                      </label>
                      <input
                        type="number"
                        id="transfusion_till_date.LD"
                        name="transfusion_till_date.LD"
                        value={formData.transfusion_till_date.LD}
                        onChange={handleInputChange}
                        className="w-full px-4 py-3 bg-white text-gray-900 border border-gray-300 rounded-lg focus:ring-0 focus:ring-red-500 focus:border-red-500 outline-none transition-all"
                        placeholder="Units"
                      />
                    ...
                    <div className="space-y-2">
                      <label
                        htmlFor="transfusion_till_date.total"
                        className="block text-sm font-medium text-gray-700"
                      >
                        Total
                      </label>
                      <input
                        type="number"
                        id="transfusion_till_date.total"
                        value={formData.transfusion_till_date.total}
                        readOnly
                        className="w-full px-4 py-3 bg-gray-100 text-gray-900 border border-gray-300 rounded-lg outline-none transition-all"
                      />
                    </div>
                  </div>
                </div>
                <div className="mt-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="space-y-2">
                      <label
                        htmlFor="replacement_till_date.Family"
                        className="block text-sm font-medium text-gray-700"
                      >
                        Family
                      </label>
                      <input
                        type="number"
                        id="replacement_till_date.Family"
                        name="replacement_till_date.Family"
                        value={formData.replacement_till_date.Family}
                        onChange={handleInputChange}
                        className="w-full px-4 py-3 bg-white text-gray-900 border border-gray-300 rounded-lg focus:ring-0 focus:ring-red-500 focus:border-red-500 outline-none transition-all"
                        placeholder="Units"
                      />
                    ...
                    <div className="space-y-2">
                      <label
                        htmlFor="replacement_till_date.Relatives"
                        className="block text-sm font-medium text-gray-700"
                      >
                        Relatives
                      </label>
                      <input
                        type="number"
                        id="replacement_till_date.Relatives"
                        name="replacement_till_date.Relatives"
                        value={formData.replacement_till_date.Relatives}
                        onChange={handleInputChange}
                        className="w-full px-4 py-3 bg-white text-gray-900 border border-gray-300 rounded-lg focus:ring-0 focus:ring-red-500 focus:border-red-500 outline-none transition-all"
                        placeholder="Units"
                      />
                    ...
                    <div className="space-y-2">
                      <label
                        htmlFor="replacement_till_date.Friends"
                        className="block text-sm font-medium text-gray-700"
                      >
                        Friends
                      </label>
                      <input
                        type="number"
                        id="replacement_till_date.Friends"
                        name="replacement_till_date.Friends"
                        value={formData.replacement_till_date.Friends}
                        onChange={handleInputChange}
                        className="w-full px-4 py-3 bg-white text-gray-900 border border-gray-300 rounded-lg focus:ring-0 focus:ring-red-500 focus:border-red-500 outline-none transition-all"
                        placeholder="Units"
                      />
                    ...
                    <div className="space-y-2">
                      <label
                        htmlFor="replacement_till_date.Organisations"
                        className="block text-sm font-medium text-gray-700"
                      >
                        Organisations
                      </label>
                      <input
                        type="number"
                        id="replacement_till_date.Organisations"
                        name="replacement_till_date.Organisations"
                        value={formData.replacement_till_date.Organisations}
                        onChange={handleInputChange}
                        className="w-full px-4 py-3 bg-white text-gray-900 border border-gray-300 rounded-lg focus:ring-0 focus:ring-red-500 focus:border-red-500 outline-none transition-all"
                        placeholder="Units"
                      />
                    ...
                    <div className="space-y-2">
                      <label
                        htmlFor="replacement_till_date.total"
                        className="block text-sm font-medium text-gray-700"
                      >
                        Total
                      </label>
                      <input
                        type="number"
                        id="replacement_till_date.total"
                        value={formData.replacement_till_date.total}
                        readOnly
                        className="w-full px-4 py-3 bg-gray-100 text-gray-900 border border-gray-300 rounded-lg outline-none transition-all"
                      />
                    </div>
              ...
              <div className="bg-gray-50/50 p-6 rounded-xl border border-gray-300 shadow-sm">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <label
                      htmlFor="concern_doctor"
                      className="block text-sm font-medium text-gray-700"
                    >
                      Concern Doctor <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="text"
                      id="concern_doctor"
                      name="concern_doctor"
                      value={formData.concern_doctor}
                      onChange={handleInputChange}
                      required
                      className="w-full px-4 py-3 bg-white text-gray-900 border border-gray-300 rounded-lg focus:ring-0 focus:ring-red-500 focus:border-red-500 outline-none transition-all"
