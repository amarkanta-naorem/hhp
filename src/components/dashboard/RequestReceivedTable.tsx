...
export default function RequestReceivedTable ({patients, setIsModalOpen}: any) {
    ...
    return (
        <div className="bg-white border border-gray-200 shadow-lg rounded-xl p-4 h:[42vh] md:h-[41vh]">
            ...
            <div className="relative">
                <div className="h-[39vh] md:h-[33vh] overflow-y-auto scrollbar-thin scrollbar-thumb-blue-200 scrollbar-track-gray-50">
