...
export default function RequestReceivedTable ({patients, setIsModalOpen}: any) {
    ...
    return (
        <div className="bg-white border border-gray-200 shadow-xs rounded-md p-4 h:[42vh] md:h-[41vh]">
            ...
            <div className="relative">
                <div className="h-[39vh] md:h-[33vh] overflow-y-auto no-scrollbar">
                    <table className="w-full">
                        ...
                        {patients.slice(0, 4).map((patient: any, index: any) => (
                                <tr key={index} className="hover:bg-gray-50">
                                    <td className="relative p-2 text-sm flex items-center space-x-5">
                                        <span className="relative">{patient.patient_name}</span>
                                        <span className="absolute right-1/2 -top-1.5 w-[2.5rem] bg-sky-600 text-white px-2 rounded-4xl text-[10px] md:text-xs text-center">New</span>
                                    </td>
