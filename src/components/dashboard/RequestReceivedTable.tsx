...
export default function RequestReceivedTable ({patients, setIsModalOpen}: any) {
    ...
    return (
        <div className="bg-white border border-gray-200 shadow-xs rounded-md p-4 h-auto sm:h-[72vh]">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-2 mb-4">
                <button className="w-full md:w-auto flex justify-center items-center space-x-2 bg-[#c90606] px-3 py-1.5 rounded-md text-white text-xs" onClick={() => setIsModalOpen(true)}>
                    <span>
