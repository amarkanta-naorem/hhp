export default function StatusContent ({title, count, subTitle}:any) {
    return (
        <section className="group relative max-w-sm w-full bg-white p-5 py-1 rounded-md shadow-xs cursor-pointer border border-gray-200">
            <div className="h-full flex justify-between items-start gap-4">
                <div className="h-full flex flex-col justify-between">
                    <div className="space-y-3">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[0.7rem] font-medium text-gray-400 uppercase tracking-widest">{title}</span>
                        </div>
                ...
                <div className="p-2.5 rounded-xl bg-rose-50/40 group-hover:bg-rose-50/60 transition-colors shadow-inner">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 text-rose-700/90" viewBox="0 0 14 14">
            ...
            <div className="absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-rose-100/50 to-transparent" />
        </section>
    );
}