        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.name} className="text-center">
                  <a href={link.path} className="hover:text-red-400 transition-colors inline-flex items-center gap-2"><span>{link.name}</span></a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-center md:justify-end gap-5">
              ...
              <a href="https://chat.whatsapp.com/FKkR2xFZACZ0Lv8wcuFj2M" aria-label="Join our WhatsApp group" className="p-2 rounded-full bg-[#25D366] hover:bg-[#1DA851] transition-colors flex items-center justify-center" target="_blank" rel="noopener noreferrer" >
                <svg className="w-5 h-5" fill="white" viewBox="0 0 24 24">
