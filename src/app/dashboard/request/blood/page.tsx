    ...
    <div className="bg-white border border-gray-200 shadow-xs rounded-md p-5 m-5 h-[85vh]">
      <div className="flex items-center justify-between">
        ...
        <div className="relative">
          ...
          <label htmlFor="search-blood-request" className={`absolute pointer-events-none bg-white px-1 left-3 text-slate-400 text-sm transition-all duration-300 ${inputValue ? "-top-2 text-xs text-blue-600" : "top-[3px] peer-placeholder-shown:text-sm peer-placeholder-shown:text-slate-400" } peer-focus:-top-2 peer-focus:text-xs peer-focus:text-blue-600`}>Search</label>
        </div>
      </div>
      ...
      <div className="relative">
        <div className="h-[68vh] overflow-y-auto no-scrollbar">
          <table className="w-full divide-y divide-gray-200/70">
            <thead className="sticky top-0 bg-white z-10">
              <tr>
                <th className="p-4 text-left text-sm tracking-wide font-medium whitespace-nowrap">Patient Name</th>
                <th className="p-4 text-left text-sm tracking-wide font-medium whitespace-nowrap">Phone No.</th>
                <th className="p-4 text-left text-sm tracking-wide font-medium whitespace-nowrap">Blood Gp.</th>
                <th className="p-4 text-left text-sm tracking-wide font-medium whitespace-nowrap">Age</th>
                <th className="p-4 text-left text-sm tracking-wide font-medium whitespace-nowrap">Gender</th>
                <th className="p-4 text-left text-sm tracking-wide font-medium whitespace-nowrap">Hospital</th>
                <th className="p-4 text-left text-sm tracking-wide font-medium whitespace-nowrap">Request Date</th>
                <th className="p-4 text-left text-sm tracking-wide font-medium whitespace-nowrap">Donated Date</th>
                <th className="p-4 text-center text-sm tracking-wide font-medium whitespace-nowrap">Status</th>
                <th className="p-4 text-center text-sm tracking-wide font-medium whitespace-nowrap">Action</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200/40 bg-white/50">
              {patients.map((patient: any, index: any) => (
                <tr key={index} className="group hover:bg-white/90 transition-all duration-200 ease-out">
                  ...
                  <td className="px-4 py-4 whitespace-nowrap text-center">
                    <span
                      className={`flex items-center justify-center w-[3rem] py-0.5 rounded-md text-xs font-medium ${
                        patient.gender === "Male"
                  ...
                  <td className="px-4 py-4 whitespace-nowrap text-center">
                    <button className="bg-blue-600 hover:bg-blue-700 text-white flex items-center justify-center gap-2 cursor-pointer border-2 border-blue-600 rounded-lg p-1 shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-300 transition-all duration-300 ease-in-out">
                      <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 24 24">
                        <g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} color="currentColor">
                          <path d="M20.46 17.515c.36.416.54.624.54.985s-.18.57-.54.985C19.56 20.52 17.937 22 16 22s-3.561-1.48-4.46-2.515c-.36-.416-.54-.623-.54-.985c0-.361.18-.57.54-.985C12.44 16.48 14.063 15 16 15s3.561 1.48 4.46 2.515"></path>
                          <path d="M20 13.003V7.82c0-1.694 0-2.54-.268-3.217c-.43-1.087-1.342-1.945-2.497-2.35C16.517 2 15.617 2 13.818 2c-3.148 0-4.722 0-5.98.441c-2.02.71-3.615 2.211-4.37 4.114C3 7.74 3 9.221 3 12.185v2.546c0 3.07 0 4.605.848 5.672c.243.305.53.576.855.805c.912.643 2.147.768 4.297.792"></path>
                          <path d="M3 12a3.333 3.333 0 0 1 3.333-3.333c.666 0 1.451.116 2.098-.057A1.67 1.67 0 0 0 9.61 7.43c.173-.647.057-1.432.057-2.098A3.333 3.333 0 0 1 13 2m2.992 16.5h.01"></path>
                        </g>
                      </svg>
