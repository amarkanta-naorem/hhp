        ...
        <section className="relative w-full h-screen overflow-hidden">
          ...
          <div className="relative z-10 h-full flex flex-col justify-between p-8 text-white">
            <div className="flex justify-between items-start">
              <Image src="/logo.svg" alt="HHP Logo" width={160} height={53} priority className="w-40" style={{ height: "auto" }} />
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <button onClick={() => alert('This feature is currently under development')} className="bg-white hover:bg-gray-100 text-red-600 px-6 py-3 rounded-full font-medium transition-colors cursor-pointer">Get Blood Help</button>
